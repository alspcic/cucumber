...
public class MyStepsDefSolvita {
    private WebDriver driver;

    public MyStepsDefSolvita() {this.driver = Hooks.driver;}
    ...
    public void iEnterTextZoo() {
        String textToEnter = "Zoo";
    ...
    @Given("^I go to Task (\\d+) page$")
    public void iGoToTaskPage(int arg0) {
    ...
    @Given("^I reset person list$")
    public void i_reset_person_list() {
    ...
    @Then("^I see person added to list: \"([^\"]*)\"$")
    public void i_see_person_added_to_list(String name) {
